{{
	weaponname = "Halloween C4",
	modelname = "C4",
	model = game.ReplicatedStorage.Viewmodels:FindFirstChild("v_C4Halloween")
},{
	weaponname = "Old M4A1",
	modelname = "M4A1",
	model = game.ReplicatedStorage.Viewmodels:FindFirstChild("v_oldM4A1-S")
},{
